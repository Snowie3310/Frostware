...
api.script_id = "fd97bcecafde7545db1ee5c8f66caa0a"

local savedKeyPath = "FrostWare_script.lua"
...
getKey.MouseButton1Click:Connect(function()
	...
	if selected == "linkvertise" then
		setclipboard("https://ads.luarmor.net/v/cb/UwZWrFMlaEpl/epvCeRJyhyLZTVCs")
		notif("Linkvertise link copied to clipboard!")
	elseif selected == "lootlab" then
		setclipboard("https://ads.luarmor.net/v/cb/BgrkfMGmdUqt/RxtuEXFuLtHLBlfp")
...
verify.MouseButton1Click:Connect(function()
	...
	if status.code == "KEY_VALID" then
		...
		loadstring(game:HttpGet("https://api.luarmor.net/files/v3/loaders/fd97bcecafde7545db1ee5c8f66caa0a.lua"))()
		gui:Destroy()
